...
String parseHtmlString(String htmlString) {
  if (!htmlString.contains('href=')) return htmlString;
  final _element = parse(htmlString).getElementsByTagName('a')[0];
  if ((_element.innerHtml).contains('#') || (_element.innerHtml).contains('@'))
    return parse(htmlString).body!.text;
  return _element.attributes['href']!;
}
