...
class AppIcons {
  ...
  static Widget showLikesIcon({Color? color}) =>
      Images.showLikes.toSvg(height: 30, width: 30, color: color);
  ...
  static Widget clearChatIcon =
      Images.clearChat.toSvg(color: Colors.white, width: 20, height: 20);
  ...
  static Widget reportIcon({Color? color}) =>
      Images.reportOption.toSvg(height: 30, width: 30, color: color);
  //drawer
  ...
  static Widget bookmarkOption({double size = drawerMenuSize}) =>
      Images.bookmarkOption
          .toSvg(height: 30, width: 30, color: AppColors.white);
