...
class PostRepoImpl extends PostRepo {
  ...
  Future<Either<Failure, MediaEntity>> uploadMedia(MediaData mediaData) async {
    ...
    return either.fold(
      (l) => left(l),
      (r) {
        final MediaUploadResponse _mediaUploadRes =
            MediaUploadResponse.fromJson(r.data);
        final MediaEntity _mediaEntity =
            MediaEntity.fromResponse(_mediaUploadRes.data!);
        print('WARNING: ' + '$_mediaEntity');
        return right(
          MediaEntity.fromResponse(
